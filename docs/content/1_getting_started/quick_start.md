...
- [How to create your own Catalog](../4_building_your_platform/create_catalog.md)
- [How to add an Application](../5_workload_onboarding/add_application.md)
- [How to add an AppSet](../5_workload_onboarding/add_appset.md)
