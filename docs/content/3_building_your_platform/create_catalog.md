...
If you only need to add a simpler workload to one cluster or one team space, use the Argo CD guides in [Workload Onboarding with Argo CD](../4_workload_onboarding/overview.md) instead.
